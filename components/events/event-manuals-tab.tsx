    ...
    <div className="space-y-6">
                  ...
                  <div className="flex gap-2">
                    <Dialog>
                      ...
                      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                        ...
                        <div className="mt-4">
                          <pre className="whitespace-pre-wrap text-sm bg-gray-50 p-4 rounded-lg">{manual.content}</pre>
                        </div>
                      </DialogContent>
                    </Dialog>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Funciones de colaboración estilo Google Docs (próximamente)</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">Múltiples usuarios editando en tiempo real</p>
            </div>

            <div className="text-center p-4 border rounded-lg">
              <MessageSquare className="w-8 h-8 text-green-600 mx-auto mb-2" />
              <h4 className="font-medium">Comentarios</h4>
              <p className="text-sm text-muted-foreground">Sistema de comentarios con @menciones</p>
            </div>
