...
import { upcomingEvents30d } from "@/store/unified-event-store"
...
export default function EventsPage() {
  ...
  // Filtrar eventos próximos a los próximos 30 días
  ...
  const filteredAndSortedEvents = useMemo(() => {
    ...
    return filtered
  }, [upcomingEvents, searchTerm, statusFilter, typeFilter, sortBy])
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Eventos próximos a los próximos 30 días • {totalEvents} eventos • {confirmedEvents} confirmados •{" "}
            ...
            <Card key={event.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex gap-2 pt-2">
                  <CountdownDisplay targetDate={event.date} className="mb-2" />
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center text-sm text-muted-foreground">
              Mostrando {filteredAndSortedEvents.length} de {totalEvents} eventos en los próximos 30 días
              <br />
              Los eventos anteriores al límite de 30 días están archivados y no se muestran
            </div>
          </CardContent>
        </Card>
      )}
